...
function renderHeader(activePage) {
  ...
  const logoSrc = isRoot ? BRAND_LOGOMARK_SRC : "../" + BRAND_LOGOMARK_SRC;
  ...
  <header class="site-header" id="siteHeader">
    <div class="container">
      <a href="${isRoot ? '#' : '../index.html'}" class="brand">
        <span class="brand-mark"><img src="${logoSrc}" alt="${BRAND.name} logo"></span>
        <span class="brand-name-full">${BRAND.name}</span><span class="brand-name-short">${BRAND.shortName}</span>
      </a>
      <nav class="nav-links">
    ...
    <div class="container">
      <div class="footer-grid">
        <div class="footer-brand">
          <a href="${isRoot ? '#' : '../index.html'}" class="brand">
            <span class="brand-mark"><img src="${logoSrc}" alt="${BRAND.name} logo"></span>${BRAND.name}
          </a>
          <p>${BRAND.tagline}</p>
        ...
        <div>
          ...
          <ul>
            ...
            <li>${icon("pin")} ${BRAND.serviceCity} · ${BRAND.serviceRadius}</li>
          </ul>
        </div>
      </div>
