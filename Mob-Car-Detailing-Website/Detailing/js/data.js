...
// NOTE: this number was not changed as part of the Melbourne/Australia
// update — it's carried over from the previous market. Update it here to
// your real Australian WhatsApp Business number before going live.
const WHATSAPP_NUMBER = "923174481564";
// Shown next to "Book Now" in the navbar, formatted for display only —
// the actual number used for every wa.me link is WHATSAPP_NUMBER above.
// Keep these two in sync if you change the number.
const WHATSAPP_DISPLAY = "+92 317 4481564";
...
// in AUD for a Sedan; other vehicle prices derive from VEHICLE_TYPES
// multipliers so pricing stays consistent everywhere.
// NOTE: these are placeholder estimates for the Melbourne market — update
...
const ADDONS = [
  { id: "engine-bay", name: "Engine Bay Cleaning", icon: "sparkle", price: 35 },
  { id: "headlight", name: "Headlight Restoration", icon: "sparkle", price: 49 },
  { id: "odor", name: "Odor Elimination", icon: "sparkle", price: 39 },
  { id: "pet-hair", name: "Pet Hair Removal", icon: "sparkle", price: 45 },
  { id: "ceramic-boost", name: "Ceramic Spray Boost", icon: "sparkle", price: 29 },
  { id: "carpet", name: "Carpet Extraction", icon: "sparkle", price: 59 },
];
...
const TESTIMONIALS = [
  { name: "Sarah M.", meta: "Toyota Corolla · South Yarra", quote: "They showed up right on time and my car looked better than when I bought it. The interior smells amazing.", rating: 5, platform: "Google" },
  { name: "Josh K.", meta: "Honda Civic · Richmond", quote: "Booking on WhatsApp took two minutes and they handled a seriously muddy car without blinking.", rating: 5, platform: "Google" },
  { name: "Priya R.", meta: "Toyota Camry · Brighton", quote: "The ceramic coating is worth every dollar — water just sheets right off after rain now.", rating: 5, platform: "Google" },
  { name: "Daniel T.", meta: "Subaru Outback · Fitzroy", quote: "Easy to reschedule when it rained, and the crew was friendly and fast the next time around.", rating: 4, platform: "Google" },
  { name: "Monica L.", meta: "Kia Sportage · St Kilda", quote: "Best pet hair removal I've found — my dog rides in this car every day and it looked spotless after.", rating: 5, platform: "Google" },
];
...
/* ==========================================================================
   ...
   brand logo itself is a real image (assets/images/logo-wide.png), not an
   icon — see BRAND_LOGO_SRC below.
   ========================================================================== */
const BRAND_LOGO_SRC = "assets/images/logo-wide.png";
